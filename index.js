...
app.route('/api/users').get((req, res) => {
  ...
  User.findOne({username: potentialUsername}, (error, data) => {
    ...
    if(!data){
      ...
      res.send(`Username ${potentialUsername} already exist.`)
      console.log(`Username ${potentialUsername} already exist.`)
    }
  });
});
